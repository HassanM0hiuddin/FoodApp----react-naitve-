...
export default function CustomerSignin() {
  ...
  const sendEmail = async () => {
    ...
    const emailData = {
      ...
      recipients: ['hassanmohiuddin73@gmail.com'], // Email address(es) to send the feedback
      body: `
        Feedback Details:
        ------------------------------
  ...
  const createTwoButtonAlert = () =>
    Alert.alert(
      '',
      'Thank you for choosing our restaurant and taking the time to provide us with your feedback. We greatly value your opinion as it helps us improve our services and enhance your dining experience.',
    ...
    <View style={styles.main}>
      ...
      <View style={styles.sec}>
        <TouchableOpacity style={styles.TouchableOpacity}>
          <Text style={styles.txt} onPress={sendEmail}>
            Submit
          </Text>
        </TouchableOpacity>
      </View>
