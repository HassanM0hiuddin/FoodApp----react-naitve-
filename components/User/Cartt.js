    ...
    <ScrollView style={styles.main}>
      ...
      <View style={{marginBottom: '5%'}}>
        {dishes.map((dish, index) => (
          <View key={dish.id} style={styles.TouchableOpacity}>
            <View style={{}}>
...
/> */}
            ...
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity
                ...
                onPress={() =>
                  updateCartItemQuantity(dish.id, dish.quantity - 1)
                }>
                <Text
                  style={[
                    styles.txt,
        ...
        <View style={[styles.TouchableOpacitye, {height: 70, marginBottom: 2}]}>
          <Text style={styles.txt}>Sub-Total</Text>
          <Text style={[styles.txt, {color: '#F76106'}]}>RS {subTotal}</Text>
        </View>
        <View style={[styles.TouchableOpacitye, {height: 70}]}>
