...
export default function CustomerSignin() {
  ...
  const createTwoButtonAlert = () =>
    Alert.alert(
      '',
      'Thank you for sending us email we will soon entertain  you query',
  ...
  return (
    <View style={styles.main}>
      <View style={styles.upper}>
        ...
        <Text style={styles.txt}>How we Can help you</Text>
      </View>
      ...
      <View style={styles.sec}>
        <TouchableOpacity style={styles.TouchableOpacity}>
          <Text style={styles.txt} onPress={createTwoButtonAlert}>
            Submit
          </Text>
        </TouchableOpacity>
      </View>
